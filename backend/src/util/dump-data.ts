export const data = [
    {
        ...
        slug: 'arroz-de-mariscos-para-2-pessoas',
        description:
    ...
    },
    {
        ...
        time: 2400000,
        pictures: {
            thumb: 'prato-moqueca-peq.jpg',
            hero: 'prato-moqueca-grande.jpg'
        },
        finished: true
    },
    {
        name: 'Frutos do Mar ao Azeite de Ervas',
        slug: 'frutos-do-mar-ao-azeite-de-ervas',
        description:
        ...
        time: 1800000,
        pictures: {
            thumb: 'prato-fruto-peq.jpg',
            hero: 'prato-fruto-grande.jpg'
        },
        finished: true
    },
    {
        name: 'Massa espaguete à Italiana',
        slug: 'massa-espaguete-a-italiana',
        description:
            'Espaguete italiano coberto com mexilhões, lula, polvo, camarões, salteados no azeite com alho, cebola, molho de tomates frescos e manjericão.',
        ingredients: [
            '200 gr Espaguete',
            '6 unidades de vieira',
            '6 unidades de camarão rosa',
        ...
        time: 1080000,
        pictures: {
            thumb: 'prato-massa-peq.jpg',
            hero: 'prato-massa-grande.jpg'
        },
        finished: true
    },
    {
        name: 'Bobó de Lagosta',
        slug: 'bobo-de-lagosta',
        description:
        ...
        time: 3000000,
        pictures: {
            thumb: 'prato-bobo-peq.jpg',
            hero: 'prato-bobo-grande.jpg'
        },
        finished: true
    }
]
